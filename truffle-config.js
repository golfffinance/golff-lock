...
module.exports = {
  ...
  networks: {
    ...
    ether_main: {
      provider: new HDWalletProvider(mnemonic, `https://mainnet.infura.io/v3/f7f1e925ea6f4fdd8761e6e3c656f18f`),
      network_id: 1,
      gas: 3012388,
      gasPrice: 1000000000,
    ...
    ether_rinkeby: {
      provider: new HDWalletProvider(mnemonic, `https://rinkeby.infura.io/v3/f7f1e925ea6f4fdd8761e6e3c656f18f`),
      network_id: 4,
      gas: 8000000,
      gasPrice: 1000000000,
      networkCheckTimeout: 60000,
